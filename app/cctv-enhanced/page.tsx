...
export default function EnhancedCCTVMonitoringPage() {
  const { user } = useAuth();
  ...
  const getGateTypeBadge = (gateType: string) => {
    switch (gateType) {
      case "entrance":
        return <Badge className="bg-blue-600 text-white">Entrance</Badge>;
      case "exit":
        return <Badge className="bg-purple-600 text-white">Exit</Badge>;
      case "both":
        return <Badge className="bg-orange-600 text-white">Both</Badge>;
      default:
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-gray-400">
                    Multi-camera and multi-gate system management
                  </p>
                </div>
              </div>
              <Button
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <div>
                          ...
                          <p className="text-gray-400 text-sm">
                            Last: {gate.lastAction}
                          </p>
                        </div>
                      </div>
                      {getGateTypeBadge(gate.gateType)}
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center justify-between">
                      ...
                      <Badge className="bg-blue-600 text-white">
                        {camera.targetGateIds.length} gate(s)
                      </Badge>
                    </div>
                    ...
                    <div className="text-gray-400 text-sm">
                      Controls:{" "}
                      {gates
                        .filter((g) => camera.targetGateIds.includes(g.gateId))
                        .map((g) => g.gateName)
                        .join(", ")}
                    </div>
                  </div>
